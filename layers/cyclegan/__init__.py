# A DUPLICATE OF https://github.com/xhujoy/CycleGAN-tensorflow/module.py
from __future__ import division
import tensorflow as tf
from layers.cyclegan.ops import *
...
def generator_resnet(image, options, reuse=False, name="generator"):
    ...
    with tf.variable_scope(name, reuse=reuse):
        ...
        #print (d2)
        no_activate = conv2d(d2, options.output_c_dim, 7, 1, padding='VALID', name='g_pred_c')
        #print (no_activate)
        pred = tf.nn.tanh(no_activate)

        return pred, no_activate
